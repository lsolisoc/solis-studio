         ...
         {selectedProject && (
           ...
           >
             ...
             >
               ...
               <span className={`text-xs font-medium ${categoryColors[selectedProject.category].text} uppercase tracking-wider`}>
               ...
               <p className="text-muted-foreground font-light mb-8">{selectedProject.description}</p>
 
               <div className="space-y-6">
                 <div>
                   <h4 className="text-sm font-medium text-foreground mb-2">Problem</h4>
                   <p className="text-sm text-muted-foreground font-light">{selectedProject.details.problem}</p>
                 </div>
                 <div>
                   <h4 className="text-sm font-medium text-foreground mb-2">Role & Tools</h4>
                   <p className="text-sm text-muted-foreground font-light">{selectedProject.details.role}</p>
                 </div>
                 <div>
                 ...
                 <div>
                   ...
                   <p className="text-sm text-muted-foreground font-light">{selectedProject.details.impact}</p>
                 </div>
               </div>
