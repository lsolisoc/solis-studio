...
const projects: Project[] = [
  ...
  /*Chopin AI*/
  {
    ...
    details: {
      ...
      approach: [
        ...
        'Conducted user testing sessions and implemented updates based on feedback',
      ],
  ...
  /*MCC SaaS Workflow*/
  {
    ...
    details: {
      ...
      impact: '60% faster delivery, 80% reduction in estimating time, and enhanced ESG reporting capabilities. Improved user adoption across global operations.',
  ...
  /*Briteline*/
  {
    ...
    details: {
      ...
      impact: '40%+ efficiency gains, 30% revenue growth, and 60% technology adoption across client base.',
  ...
  /*Mintlypro - Industrial Software*/
  {
    ...
    description: 'Led 0-1 development of SaaS monitoring platform adopted by manufacturing sites.',
  ...
  /*Renewable Energy Innovation*/
  {
    ...
    details: {
      ...
      impact: 'Enabled energy independence for underserved communities with scalable, decreasing costs and promoting locally-manufacturable design.',
  ...
  /*Sustainable Biofuels*/
  {
    ...
    details: {
      ...
      impact: 'Successfully produced bioethanol from waste paper and demonstrated viable pyrolysis process for avocado seed waste. Published findings proving circular economy concept.',
